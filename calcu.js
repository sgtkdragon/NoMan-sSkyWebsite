...
var processEntries = function() {
    ...
    var autonomouspositioningunit = parseFloat($("autonomouspositioningunit").value);
    var bromidesalt = parseFloat($("bromidesalt").value);
    var cometdroplets = parseFloat($("").value);
    var descentedpheromonebottle = parseFloat($("").value);
    var decommissionedcircuitboard = parseFloat($("").value);
    var decryteduserdata = parseFloat($("").value);
    var  = parseFloat($("").value);
    var  = parseFloat($("").value);
    var  = parseFloat($("").value);
    var  = parseFloat($("").value);
    var  = parseFloat($("").value);
